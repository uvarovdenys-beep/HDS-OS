...
# ──────────────────────────────────────────────────────────────
# Split out under R-300 into ai_callers.py. Re-exported here so every existing
# import site (agent_ai_pipeline, the CLI below) keeps working unchanged.

from ai_callers import (  # noqa: F401

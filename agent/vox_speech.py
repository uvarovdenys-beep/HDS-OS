...
"""
vox_speech.py
HDS PowerVox Speech Module - Якісна британська озвучка
...
class HDSVoxSpeech:
    ...
    def __init__(self, base_dir: Path = None, voice: str = None, prefer_system: bool = False):
        ...
        self.temp_dir = Path(tempfile.gettempdir()) / "hds_vox"
    ...
    async def _edge_tts_speak(self, text: str) -> bool:
        ...
        try:
            ...
            temp_file = self.temp_dir / f"hds_vox_{timestamp}.mp3"
    ...
    def system_announcement(self) -> bool:
        ...
        announcement = "HDS Agent Nucleus operational. Monitoring active."
    ...
    def test_all_voices(self):
        ...
        test_text = "HDS PowerVox test. System operational."
        
        print("=" * 60)
        print("HDS PowerVox Voice Test")
        print("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="HDS PowerVox Speech - Quality British Voice",
    ...
    vox = HDSVoxSpeech(voice=args.voice)
    
    if args.check:
        print("HDS PowerVox Speech Check")
        print("=" * 40)

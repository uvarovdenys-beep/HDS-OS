# HDS Local Model & Task Queue Analysis
...
1. **No Queue-to-Model Bridge** (Line: `ai_driver_pipeline.py:260-288`)
   ...
   - Only checks for `HDSAgent` execution, ignoring local model preference

...
The HDS Local Model UI Agent is a desktop application for interacting with local AI models running on:
...
```bash
python3 /path/to/HDS/agent/local_model_ui_agent.py
```
...
```
============================================================
HDS - Qwen Coder 14b on LM Studio Test Suite

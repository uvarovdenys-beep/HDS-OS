...
REQUIRED:
- Use HDSScribe for all file operations
- Include task_id in all operations
- Validate content before processing
FULL_DOCS: ai-mind/knowledge/hds_ai_complete_documentation.md
```
...
FORBIDDEN:
- Direct file writes (use HDSScribe)
...
CONTEXT: Coordinate multiple HDS components for complex task
CAPABILITIES:
...
CHECK: Use HDSScribe._check_size_alert()
```

### **R-13: Task-First Protocol**
```
CONSTRAINT: All operations require task_id
VIOLATION: Use HDS task pipeline
...
```
CONSTRAINT: Use HDSScribe for file operations
VIOLATION: Replace with HDSScribe.write_file()
...
| Integration | Resource Usage | HDS Integration | 15 min | Stop system |
...
4. Save via HDSScribe with task_id
5. Close session
...
### **Full Documentation**
```
Reference: ai-mind/knowledge/hds_ai_complete_documentation.md

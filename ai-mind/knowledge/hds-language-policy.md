...
### Системна мова (HDS Core)
- **English** — всі системні файли HDS, документація ядра, коментарі в коді
...
def check_r08_language_policy(self, content: str, is_response: bool) -> ComplianceResult:
    ...
    if not is_response:
        ...
        return ComplianceResult(
            ...
            rule_code="R-08",
            message="R-08 INFO: HDS core is English-language"
        )
...
- [ ] HDS core файли залишати англійською

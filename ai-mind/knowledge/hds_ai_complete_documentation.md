# HDS AI System - Complete Documentation for AI Assistants
...
HDS AI System is a comprehensive artificial intelligence operating system designed for autonomous task execution, web analysis, computer vision, and intelligent automation. The system follows strict R-Series protocols for code quality and operational integrity.
...
│                    HDS AI OS                              │
├─────────────────────────────────────────────────────────────┤
│  Integration Layer (hds_os_integration.py)                │
├─────────────────────────────────────────────────────────────┤
...
**Usage Example**:
```python
from browser_agent import HDSBrowserAgent, NavigationRequest

# Initialize agent
agent = HDSBrowserAgent()
...
### 8. HDS OS Integration

**File**: `hds_os_integration.py`

**Purpose**: Unified control system for all HDS components.
...
**Usage Example**:
```python
from hds_os_integration import HDSOSIntegration

# Initialize system
integration = HDSOSIntegration(base_dir)
...
integration = HDSOSIntegration(base_dir="/path/to/hds")
...
base_dir = Path("/path/to/hds")
if not (base_dir / "ai-mind").exists():
    print("Invalid HDS directory")
...
from browser_agent import HDSBrowserAgent
agent = HDSBrowserAgent()
...
def run_crash_test():
    test_file = base_dir / "ai-mind/tasks/active/hds_crash_test.py"
...
- **Crash Test Results**: `ai-mind/logs/hds_crash_test_*.json`
...
2. Run crash test: `python ai-mind/tasks/active/hds_crash_test.py`
...
This documentation provides comprehensive information for AI assistants to understand, integrate, and operate the HDS AI System effectively.

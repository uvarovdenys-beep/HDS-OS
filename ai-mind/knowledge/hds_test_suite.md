...
├── ai-mind/knowledge/
│   └── hds_test_suite.md # ← Цей файл (специфікація)
...
python -c "from agent.agent import HDSAgent; print('Agent OK')"
```
